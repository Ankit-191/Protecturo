        ...
        <Container className="pt-lg-5 pt-2">
          <Row>
            <Col lg={4}>
              ...
              <p className="ff_Gilroy fw_500 fs_sm clr_gray_100 mt-3 pe-xl-3">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
                enim ad minim veniam, quis nostrud exercitation ullamco laboris
                nis commodo consequat.
              </p>
              <div className="d-flex gap-3 mt-lg-4 mt-3 mb-4 footericon">
                <a href="#">
                  <img
                    src={telegram}
                    alt="telegram"
            ...
            <Col xs={6} md={3} lg={2}>
              <p className="ff_Gilroy fw_700 fs_2xl clr_white mt-4 pb-lg-1">
                Products
              </p>
          ...
          <div className="d-md-flex justify-content-between py-lg-4 py-3 mt-lg-3">
            <p className="ff_Gilroy fw_500 fs_sm clr_gray_100">

        ...
        <Container>
          <Row className="align-items-center justify-content-center">
            ...
            <Col lg={6} data-aos="zoom-out-left" data-aos-duration="1000">
              ...
              <p className="ff_Gilroy fw_500 fs_xl clr_gray_100 mw_787 mb-xl-4 mb-3 pb-xl-3">
                At vero eos et accusamus et iusto odio dignissimos ducimus qui
                blanditiis praesentium voluptatum deleniti atque corrupti quos
                dolores et quas molestias excepturi sint occaecati cupiditate
                non provident.
              </p>
              <p className="ff_Gilroy fw_500 fs_xl clr_gray_100 mw_787 mb-xl-5 mb-3 pb-xl-2">
